...
public class SearchFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    FriendListAdapter recentCallAdapter;
    ...
    private void xmlini(View rootView) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                ...
                recentCallAdapter.getFilter().filter(query);
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            HttpPost httppost = new HttpPost(Constants.URL_userlist);
    ...
    private void setdata() {
        ...
        if (userlist.size() > 0) {
            ...
            recentCallAdapter = new FriendListAdapter(getActivity(), userlist);
