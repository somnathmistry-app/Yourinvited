...
import com.devonetech.android.yourinvited.social_network.adapter.LocationAdapter;
...
public class ShareLocationActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void shareCurrentLocation() {
        ...
        if (!currentlat.equals("")&&!currentlong.equals("")){
            ...
            Intent intent=new Intent(ShareLocationActivity.this,TagFriendsActivity.class);
            intent.putExtra("search_location", currentaddress);
            intent.putExtra("search_lat", currentlat);
            intent.putExtra("search_laong", currentlong);
    ...
    private void setdata() {
        ...
        AllAddressAdapter recentCallAdapter = new AllAddressAdapter(this,locationList);
