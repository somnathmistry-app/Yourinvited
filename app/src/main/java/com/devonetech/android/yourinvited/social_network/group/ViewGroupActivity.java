...
import com.devonetech.android.yourinvited.social_network.group.adapter.MembersAdapter;
...
public class ViewGroupActivity extends AppCompatActivity {
    ...
    RecyclerView recycler_view,recyclerView_members;
    ArrayList<FeedPostModel> allFeedsList;
    ArrayList<MyGrops> memberList;
    ...
    private TextView userName,memberCount;
    ...
    private void xmlInit() {
        profile_iv=findViewById(R.id.imageView4);
        groupPost=findViewById(R.id.top_lay);
        ...
        userName=findViewById(R.id.group_name);
        memberCount=findViewById(R.id.group_count);

        recycler_view =findViewById(R.id.my_recycler_view);
        mAdapter = new FriendProofileAdapter(ViewGroupActivity.this);

        linearLayoutManager = new LinearLayoutManager(this) {

            @Override
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int position) {
                LinearSmoothScroller smoothScroller = new LinearSmoothScroller(ViewGroupActivity.this) {
...
*/
        ...
        recyclerView_members =findViewById(R.id.group_members);
        LinearLayoutManager linearLayout1 = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        recyclerView_members.setLayoutManager(linearLayout1);
        recyclerView_members.setItemAnimator(new DefaultItemAnimator());

        groupPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ViewGroupActivity.this,PostInGroupActivity.class);
    ...
    private void setIntentData() {
        ...
        userName.setText(mIntent.getStringExtra("group_name"));
        memberCount.setText("Public Group "+mIntent.getStringExtra("group_member")+" Members");



        if (!mIntent.getStringExtra("group_image").equals("")) {
            try {
                String apiLink = mIntent.getStringExtra("group_image");
        ...
        if (!mIntent.getStringExtra("group_member_list").equals("")){

            try {
                JSONArray jj=new JSONArray(mIntent.getStringExtra("group_member_list"));
                memberList=new ArrayList<>();

                for (int i = 0; i <jj.length() ; i++) {
                    JSONObject object=jj.getJSONObject(i);
                    MyGrops item=new MyGrops(object.getString("name"),object.getString("user_id"),object.getString("profie_image"));
                    memberList.add(item);
    ...
    private void loadFirstPage() {
        ...
        if (AppController.getInstance().isConnected()) {
            progressDialog = Helper.setProgressDailog(ViewGroupActivity.this);

            StringRequest strRequest = new StringRequest(Request.Method.POST, Constants.URL_GroupFeedList,
                            ...
                            try {
                                ...
                                if (status.equals("1")) {
                                  ...
                                  //  mAdapter.removeLoadingFooter();
                                    //  swipeRefreshLayout.setRefreshing(false);
                                    Toast.makeText(ViewGroupActivity.this, msg, Toast.LENGTH_SHORT).show();
                                }
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("group_id",mIntent.getStringExtra("group_id"));
            ...
            Toast.makeText(ViewGroupActivity.this, "No internet connection", Toast.LENGTH_SHORT).show();
        }
