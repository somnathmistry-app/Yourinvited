...
public class FriendofFriendAdapter extends RecyclerView.Adapter<FriendofFriendAdapter.ViewHolder> implements Filterable {
    ...
    public FriendofFriendAdapter(Context context) {
       // this.items = items;
  ...
  /*  public FriendofFriendAdapter(Context context) {
    ...
    @Override
    public FriendofFriendAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_friends, parent, false);
        return new FriendofFriendAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final FriendofFriendAdapter.ViewHolder holder, final int position) {
...
/*
    ...
    public Filter getFilter() {
        ...
        if(filter == null)
        {
            filter=new FriendofFriendAdapter.CustomFilter();
        }
