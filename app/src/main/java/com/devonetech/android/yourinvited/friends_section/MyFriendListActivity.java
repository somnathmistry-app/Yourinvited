...
import com.devonetech.android.yourinvited.friends_section.adapter.MyFriendsAdapter;
...
public class MyFriendListActivity extends AppCompatActivity {
    ...
    private void setdata() {
        ...
        MyFriendsAdapter recentCallAdapter = new MyFriendsAdapter(this,userlist);
        recycler_view.setAdapter(recentCallAdapter);
    }
