...
public class FeedsFragmentPagination extends Fragment implements SwipeRefreshLayout.OnRefreshListener{

    public FeedsFragmentPagination() {
    ...
    AllFeedsPaginationAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.all_feeds_fragment, container, false);
    ...
    private void xmlini(View rootView) {
        ...
        mAdapter = new AllFeedsPaginationAdapter(getActivity());
